...
public class JumpUtil {
    ...
    public static void next(Activity curActivity, Class nextActivity) {
        next(curActivity, nextActivity, null, -1, -1, R.anim.in_pop_anim, R.anim.out_pop_anim);
    }
    ...
    public static void next(Activity curActivity, Class nextActivity, Bundle extras, int reqCode) {
        next(curActivity, nextActivity, extras, reqCode, -1, R.anim.in_pop_anim, R.anim.out_pop_anim);
    }
    ...
    public static void goBack(Activity curActivity) {
        goBack(curActivity, R.anim.out_pop_anim, R.anim.in_pop_anim);
    }
    ...
    public static void goBackWithResult(Activity curActivity, int retCode, Bundle retData) {
        goBackWithResult(curActivity, retCode, retData, R.anim.out_pop_anim, R.anim.in_pop_anim);
    }
    ...
    public static void backActivityWithClearTop(Activity curActivity, Class backActivity) {
        backActivityWithClearTop(curActivity, backActivity, null, R.anim.out_pop_anim, R.anim.in_pop_anim);
    }
    ...
    public static void backActivityWithClearTop(Activity curActivity, Class backActivity, Bundle extras) {
        backActivityWithClearTop(curActivity, backActivity, extras, R.anim.out_to_left, R.anim.out_to_right);
    }
